      ...
      <div className={styles.root}>
        ...
        <div className={styles.attributeContainer}>
          <Split
            ...
            description={
              'We create our art by pouring our heart and soul, our aim is to inspire people to live with few timeless movies made to last. This is why quality over quantity is a cornerstone of our ethos and we have no interest in meagre tasks.' 
            }
            ctaText={'learn more'}
            cta={() => navigate('/blog')}
